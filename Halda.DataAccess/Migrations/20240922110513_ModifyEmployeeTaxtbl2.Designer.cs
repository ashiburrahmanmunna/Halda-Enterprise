...
namespace Halda.DataAccess.Migrations
{
    ...
    [Migration("20240922110513_ModifyEmployeeTaxtbl2")]
    partial class ModifyEmployeeTaxtbl2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Halda.Core.Models.Applicant", b =>
                {
                    ...
                    b.Property<decimal?>("ExpSalary")
                        .HasColumnType("numeric")
                        .HasColumnName("expsalary");
                    ...
                    b.Property<string>("PrevOrCurrCompany")
                        .HasColumnType("text")
                        .HasColumnName("prevorcurrcompany");
            ...
            modelBuilder.Entity("Halda.Core.Models.PreOnboarding.ApplicantDoc", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text")
                        .HasColumnName("id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_applicantdocs");

                    b.HasIndex("ApplicantId")
                        .HasDatabaseName("ix_applicantdocs_applicantid");

                    b.ToTable("applicantdocs", (string)null);
                });
            ...
            modelBuilder.Entity("Halda.Core.Models.PreOnboarding.ApplicantDoc", b =>
                {
                    b.HasOne("Halda.Core.Models.Applicant", "Applicant")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_applicantdocs_applicants_applicantid");
