...
{
    /// <inheritdoc />
    public partial class LeaveShiftCreate : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    nightcross = table.Column<TimeSpan>(type: "interval", nullable: true),
                    weekendallowtime = table.Column<TimeSpan>(type: "interval", nullable: true),
                    totalhour = table.Column<TimeSpan>(type: "interval", nullable: true),
                    companyid = table.Column<string>(type: "text", nullable: true),
                    serial = table.Column<int>(type: "integer", nullable: true),
                    userid = table.Column<string>(type: "text", nullable: true),
                    updatebyuserid = table.Column<string>(type: "text", nullable: true),
