...
namespace Halda.DataAccess.Migrations
{
    ...
    [Migration("20240902034336_AddEmployyeAddresTbl")]
    partial class AddEmployyeAddresTbl
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Halda.Core.Models.ApplicantApplicationStatus", b =>
                {
                    ...
                    b.Property<string>("JobPost_Id")
                        .HasColumnType("text")
                        .HasColumnName("jobpost_id");

                    b.Property<string>("Milestone_Id")
                        .IsRequired()
                        .HasColumnType("text")
                    ...
                    b.HasIndex("Applicant_Id")
                        .HasDatabaseName("ix_applicantapplicationstatus_applicant_id");

                    b.HasIndex("JobPost_Id")
                        .HasDatabaseName("ix_applicantapplicationstatus_jobpost_id");

                    b.HasIndex("Milestone_Id")
                        .HasDatabaseName("ix_applicantapplicationstatus_milestone_id");
            ...
            modelBuilder.Entity("Halda.Core.Models.City", b =>
                {
            ...
            modelBuilder.Entity("Halda.Core.Models.Country", b =>
                {
                    b.Property<string>("CountryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text")
            ...
            modelBuilder.Entity("Halda.Core.Models.Department", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text")
                    ...
                    b.Property<string>("DeptBangla")
                        ...
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasColumnName("deptbangla");

                    b.Property<int?>("DeptCLevelId")
                        .HasColumnType("integer")
                        .HasColumnName("deptclevelid");
                    ...
                    b.Property<bool>("IsActualOTHide")
                        .HasColumnType("boolean")
                        .HasColumnName("isactualothide");

                    b.Property<bool>("IsActualSalaryHide")
                        .HasColumnType("boolean")
                        .HasColumnName("isactualsalaryhide");

                    b.Property<bool>("IsBuyerOTDiffer")
                        .HasColumnType("boolean")
                        .HasColumnName("isbuyerotdiffer");

                    b.Property<bool>("IsBuyerOTHide")
                        .HasColumnType("boolean")
                        .HasColumnName("isbuyerothide");

                    b.Property<bool>("IsBuyerSalaryHide")
                        .HasColumnType("boolean")
                        .HasColumnName("isbuyersalaryhide");
            ...
            modelBuilder.Entity("Halda.Core.Models.Designation", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("text")
            ...
            modelBuilder.Entity("Halda.Core.Models.JobMileStone", b =>
                {
                    ...
                    b.HasIndex("JobPostsId")
                        .HasDatabaseName("ix_jobmilestones_jobpostsid");
            ...
            modelBuilder.Entity("Halda.Core.Models.JobPost", b =>
                {
                    ...
                    b.Property<string>("Desination_Id")
                        .HasColumnType("text")
                        .HasColumnName("desination_id");
            ...
            modelBuilder.Entity("Halda.Core.Models.Milestone", b =>
                {
                    ...
                    b.Property<string>("JobDescription_Id")
                        .HasColumnType("text")
                        .HasColumnName("jobdescription_id");
                    ...
                    b.HasIndex("JobDescription_Id")
                        .HasDatabaseName("ix_milestones_jobdescription_id");
            ...
            modelBuilder.Entity("Halda.Core.Models.State", b =>
                {
                    b.Property<string>("StateId")
                        .HasColumnType("text")
                        .HasColumnName("stateid");
            ...
            modelBuilder.Entity("Halda.Core.Models.ApplicantApplicationStatus", b =>
                {
                    b.HasOne("Halda.Core.Models.Applicant", "Applicant")
                        ...
                        .HasConstraintName("fk_applicantapplicationstatus_applicants_applicant_id");

                    b.HasOne("Halda.Core.Models.JobPost", "JobPost")
                        .WithMany()
                        .HasForeignKey("JobPost_Id")
                        .HasConstraintName("fk_applicantapplicationstatus_jobposts_jobpost_id");
                    ...
                    b.HasOne("Halda.Core.Models.JobMileStone", "JobMileStone")
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_applicantapplicationstatus_jobmilestones_milestone_id");
            ...
            modelBuilder.Entity("Halda.Core.Models.City", b =>
                {
                    b.HasOne("Halda.Core.Models.Country", "Country")
                        .WithMany("Cities")
                        .HasForeignKey("CountryId")
                        .HasConstraintName("fk_citys_countries_countryid");

                    b.HasOne("Halda.Core.Models.State", "StateCity")
                        .WithMany("Cities")
            ...
            modelBuilder.Entity("Halda.Core.Models.JobDescriptionTemplate", b =>
                {
                    ...
                    b.HasOne("Halda.Core.Models.Designation", "Designation")
                        .WithMany()
            ...
            modelBuilder.Entity("Halda.Core.Models.JobMileStone", b =>
                {
                    ...
                    b.HasOne("Halda.Core.Models.JobPost", "JobPosts")
                        ...
                        .HasConstraintName("fk_jobmilestones_jobposts_jobpostsid");
            ...
            modelBuilder.Entity("Halda.Core.Models.Milestone", b =>
                {
                    ...
                    b.HasOne("Halda.Core.Models.JobDescriptionTemplate", "JobDescriptionTemplate")
                        .WithMany("Milestones")
                        .HasForeignKey("JobDescription_Id")
                        .HasConstraintName("fk_milestones_jobdescriptiontemplates_jobdescription_id");
            ...
            modelBuilder.Entity("Halda.Core.Models.State", b =>
                {
                    b.HasOne("Halda.Core.Models.Country", "StateCountry")
                        .WithMany("States")
                        .HasForeignKey("CountryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("Halda.Core.Models.User", b =>
                {
                    ...
                    b.HasOne("Halda.Core.Models.Department", "Department")
                        .WithMany()
