...
namespace Halda.DataAccess.Migrations
{
    ...
    [Migration("20240911092308_PreOnboardingModels")]
    partial class PreOnboardingModels
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Halda.Core.Models.JobPost", b =>
                {
                    ...
                    b.Property<string>("DesinationId")
                        .HasColumnType("text")
                        .HasColumnName("desinationid");
