...
namespace Halda.DataAccess.Repositories
{
         ...
         where TEntity : class
    {
        ...
        Task<IList<TEntity>> GetDynamicAsync(CancellationToken token ,Expression<Func<TEntity, bool>> filter = null, string orderBy = null, Func<IQueryable<TEntity>, IIncludableQueryable<TEntity, object>> include = null, bool isTrackingOff = false);
