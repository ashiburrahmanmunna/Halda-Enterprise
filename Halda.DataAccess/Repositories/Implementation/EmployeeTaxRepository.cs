...
{
    public class EmployeeTaxRepository : BaseRepository<EmployeeTax, string>, IEmployeeTaxRepository
    {
        public EmployeeTaxRepository(HaldaDbContext dbContext) : base(dbContext)
        {
            
        }

        public async Task SaveOrUpdateAsync(EmployeeTax model, CancellationToken token)
        {
